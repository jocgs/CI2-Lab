...
/**
 * Partidos de prueba. La mezcla está pensada para que en la demo se vean:
 *   - partidos pasados con resultado (alimentan ranking y racha)
 *   - un partido en directo (estado LIVE)
 *   - partidos próximos sobre los que apostar
 *
 * Las fechas son fijas para que la demo sea reproducible.
 */
